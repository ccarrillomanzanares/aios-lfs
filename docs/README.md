...
**Pendientes próximos**: 4 fixes de visibilidad del agente (log de comandos /tmp/aios-cmd.log, sudo -n, timeout run_command, NOPASSWD disco); acceso al portátil 2014 (IP + clave aios_portatil del VPS).
